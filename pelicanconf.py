...
DEFAULT_LANG = 'En'
EMAIL = 'sergioeprada@hotmail.com'
...
# Blogroll
LINKS = (('My CV', 'https://seprab.com/2023/03/seprabs-timeline/'),)
...
WORK_LIST = (
    ...
    ('link', 'https://i3.ytimg.com/vi/fmvXJ-wFV9s/maxresdefault.jpg', 'ML-TRAINED TANKS', 'Machine learning powered AI for simulating a tanks war. This was my final project after participating in a data analytics course with IronHack', 'https://www.youtube.com/watch?v=fmvXJ-wFV9s'),
    ...
    ('link', 'https://cloudlabs.us/wp-content/uploads/2022/04/Control-de-Procesos-EN.jpg', 'VIRTUAL LABS', "I worked with ToroLabs for migrating some virtual laboratories to Unity, and in some other cases develop a new course", 'https://cloudlabs.us/'),
